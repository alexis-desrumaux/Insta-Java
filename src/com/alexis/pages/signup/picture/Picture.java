...
import com.alexis.components.signup.picture.Content.Props;
...
public class Picture extends com.alexis.common.Component.Component {
  ...
  private void initContent() {
    ...
    Content content = new Content("Content", this, new Props(new Point((int) contentPos.getX(), (int) contentPos.getY())));
    this.add(content);
  }
